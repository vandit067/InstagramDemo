...
public class DynamicGridView extends GridView {
	...
	public void storeModule() {
		...
		// schoolVerge.getDatabase().insertModule(i+1,
		// homeScreenModulesModel.getModuleId(),homeScreenModulesModel.getModuleName(),
		// homeScreenModulesModel.getModuleDisplayName(),
		// homeScreenModulesModel.getModuleResourceActionLabel(),
		// homeScreenModulesModel.getModuleResourceController(),
		// homeScreenModulesModel.getModuleImage());
		// // schoolVerge.getDatabase().insertMenu(i + 1,
		// getAdapter().getItem(i).toString(), ((CheeseDynamicAdapter)
		// getAdapter()).getItemImage(i).toString(), ((CheeseDynamicAdapter)
		// getAdapter()).getItemActivity(i).toString());
		// }
	}
